    ...
    <div className={className}>
      ...
      <div className="mt-5 border-y border-y-neutral-100 py-6 pb-7">
        ...
        <Button
          ...
          className="text-primary bg-accent-foreground/5 hover:bg-accent-foreground/15 mt-10 ml-auto flex w-fit cursor-pointer items-center gap-1 rounded-2xl p-1 text-[12px] font-bold transition duration-300 ease-in-out"
        >
          <span>Очистить</span>
          <X className="size-4" />
        </Button>
